...
<script src="{{asset('chosen/chosen.jquery.min.js')}}"></script>
	<script>
        $(document).ready(function () {
           ...
           $("#course_training").addClass('myactive');
            $.ajaxSetup({
        headers: {
			...
			var table = $('#DataTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'course_subject', name: 'course_subject'},  
                    {data: 'score', name: 'score'},
                    {data: 'result_type_name', name: 'hr_result_type.result_type_name'},
                    {data: 'note', name: 'note'},
