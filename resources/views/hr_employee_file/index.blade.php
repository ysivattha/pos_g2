        ...
        headers: {
			...
			var table = $('#dataTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'date', name: 'date'},
                    {data: 'name_en', name: 'hr_employee.name_en'},
                    {data: 'absent_date', name: 'absent_date'},
                    {data: 'absent_type_name', name: 'absent_type_name'},
                    {data: 'reason', name: 'reason'},
                    {data: 'approved_name', name: 'hr_approved_name.approved_name'},
                    {data: 'note', name: 'note'},
